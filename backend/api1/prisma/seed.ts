...
async function main() {
  console.log("🌱 Seeding api1 database...");
  ...
  await prisma.agent.createMany({
    data: [
      {
        agent_name: "Awa Traoré",
        agent_number: "AGENT1-DB1",
      },
    ],
  });

  console.log("✅ api1 seed complete: drugs, AMO data, and a sample local agent are ready.");
}
